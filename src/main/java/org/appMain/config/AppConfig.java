...
public class AppConfig {
    ...
    public CommandLineRunner demo(final UserRepository userRepository,
        ...
        return (strings) -> {
            ...
            Product p1 = new Product("water", BigDecimal.valueOf(20d), new Date(2133333423423L), supplier1);
            Product p2 = new Product("apple", BigDecimal.valueOf(12d), new Date(213333), supplier2);
            Product p3 = new Product("orange", BigDecimal.valueOf(34d), new Date(2133333423423L), supplier1);
            Product p4 = new Product("cookie", BigDecimal.valueOf(54d), new Date(3333312423423L), supplier2);
            Product p5 = new Product("pill", BigDecimal.valueOf(212d), new Date(2123333423423L), supplier2);
            Product p6 = new Product("bread", BigDecimal.valueOf(2d), new Date(3121333333333L), supplier2);
            Product p7 = new Product("cola", BigDecimal.valueOf(1111d), new Date(1133333333213L), supplier1);
            Product p8 = new Product("sprite", BigDecimal.valueOf(167d), new Date(1133333333213L), supplier1);
            Product p9 = new Product("fanta", BigDecimal.valueOf(1d), new Date(3133333333213L), supplier1);
